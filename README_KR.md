...
<div align="center">
  ...
  <p>
    디자인, 코드, 비즈니스의 간극을 연결하는 <b>프로덕트 마인드 엔지니어</b>입니다.<br>
...
* **성능 최적화:** 2단계 Sharp 압축 파이프라인으로 스프라이트 이펙트 에셋 **75% 경량화(8MB → 2MB)**.
...
* **시스템 설계:** **3-Layer CSS 토큰 아키텍처**와 Utility Mapping, Base + Styled 컴포넌트 구조(Radix, CVA, Tailwind)로 10+ 브랜드 플랫폼 운영. 반복 UI 코드 **83% 절감**, 신규 브랜드 온보딩 **1 man-day → 1시간 미만**.
...
* **인게이지먼트:** 'Style Challenge' 리워드 설계를 개선하여 유니크 유저 참여 **50% 증가(2,000 → 3,000명)**.
...
* **렌더링:** 중복 GLSL 셰이더 노이즈 콜 92% 제거와 LOD Subdivision 기반 삼각형 88% 감소로, 29fps → 61fps 달성.
