...
<div align="center">
  ...
  <p>
    デザイン、コード、ビジネスをつなぐ<b>プロダクト志向のエンジニア</b>です。<br>
...
* **システム設計：** **3-Layer CSSトークンアーキテクチャ**とUtility Mapping、Base + Styledコンポーネント構造（Radix, CVA, Tailwind）で10+ブランドプラットフォームを運用。繰り返しのUIコードを**83%削減**、新規ブランドオンボーディング**1 man-day → 1時間未満**。
...
* **エンゲージメント：** 「Style Challenge」のリワード設計を刷新し、ユニークユーザー参加を**50%増加（2,000 → 3,000人）**。
...
* **レンダリング：** 冗長なGLSLシェーダーノイズ演算を92%削減、LOD Subdivisionで三角形数を88%削減し、29fps → 61fpsを達成。
